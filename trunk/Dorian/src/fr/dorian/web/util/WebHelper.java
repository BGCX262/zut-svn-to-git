...
public class WebHelper {
	...
	private static final Log log = LogFactory.getLog(WebHelper.class);
	...
	public static List wrapAsSelectItems(Collection collection, String strIdPropertyName, String strLabelPropertyName) {
    	...
    	if (collection != null)	{
    		for (Iterator i = collection.iterator(); i.hasNext(); ) 	{
    			...
    			try {
    				listItems.add(new SelectItem(BeanUtils.getProperty(o, strIdPropertyName).toString(), BeanUtils.getProperty(o, strLabelPropertyName).toString()));
    			}
    			catch (Exception e) {
    				log.error("WebHelper: wrapAsSelectItems: " + e.toString() + ", for " + o.toString(), e);
    			}
    		}
    	}
    	return listItems;
